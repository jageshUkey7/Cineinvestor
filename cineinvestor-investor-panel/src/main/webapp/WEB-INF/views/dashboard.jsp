...
<head>
    ...
    <title>CineInvestor Dashboard</title>
...
<body>
    ...
    <!-- Sidebar -->
    <div class="sidebar">
        <div class="logo">CineInvestor</div>
        <ul>
            <li><a href="dashboard"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
            <li><a href="#"><i class="fas fa-film"></i> <span>Projects</span></a></li>
            <li><a href="#"><i class="fas fa-chart-line"></i> <span>Investments</span></a></li>
    ...
    <div class="main-content">
        ...
        <%
            int kycPoints = 7;  // Example: Assume KYC progress is 7 out of 10
            int progressPercentage = (kycPoints * 10); // Convert to % for Bootstrap
        %>
